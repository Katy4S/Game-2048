...
function startGame() {
    if (game.getStatus() === 'idle' || game.getStatus() === 'lose' || game.getStatus() === 'win') {
        game.start();
...
/* eslint-enable function-paren-newline */ exports.default = Game;
...
//# sourceMappingURL=Game-2048.4841ef46.js.map
